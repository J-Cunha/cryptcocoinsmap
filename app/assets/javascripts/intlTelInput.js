...
(function(factory) {
   ...
   ********************/
        ...
        _initRequests: function() {
            var that = this;
            // if the users has specified the path to the utils script, fetch it on window.load, else resolve
        ...
        // called when the users selects a list item from the dropdown
        ...
        _getFullNumber: function() {
            ...
            if (this.options.separateDialCode) {
                ...
                // if the users has entered a national NANP number, then ensure it includes the full dial code / area code
