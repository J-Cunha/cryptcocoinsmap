...
LocalesExportImport::Yaml2Csv.convert(
    %w[ config/locales/en.yml config/locales/pt_BR.yml config/locales/it.yml config/locales/es.yml ],
    'crypto_coins_map_locales_en_pt_it_es.csv'
)


#---------------
#LocalesExportImport::Yaml2Csv.convert(
 #   %w[config/locales/ar.yml config/locales/de.yml config/locales/en.yml config/locales/es.yml config/locales/ge.yml config/locales/hi.yml config/locales/it.yml config/locales/ja.yml config/locales/pt_BR.yml config/locales/ru.yml],
