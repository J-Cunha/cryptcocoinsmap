LocalesExportImport::Yaml2Csv.convert(
    %w[config/locales/ar.yml config/locales/ja.yml config/locales/pt_BR.yml config/locales/en.yml config/locales/es.yml config/locales/ge.yml config/locales/hi.yml config/locales/it.yml ],
    'keys.csv'
)
